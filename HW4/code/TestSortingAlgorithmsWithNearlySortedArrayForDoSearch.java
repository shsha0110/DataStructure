...
public class TestSortingAlgorithmsWithNearlySortedArrayForDoSearch {
    private static final String[] algorithms = {"B","I","H", "M", "Q", "R"};
    private static final int ARRAY_SIZE = 50000;
    private static final double INCREMENT = 0.000001;
    private static Random rand = new Random();

    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("232_resultsDependingOnSortedRatio_size50000.csv")) {
            csvWriter.append("Algorithm,swapRate,SortedRatio,ExecutionTime\n");

            for (double swapRate = 0; swapRate <= 0.001; swapRate += INCREMENT) {
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", algorithm, String.format("%.6f",swapRate), String.format("%.6f", SortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
                }
            }
        } catch (IOException e) {
