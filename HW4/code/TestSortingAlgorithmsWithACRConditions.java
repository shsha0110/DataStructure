...
public class TestSortingAlgorithmsWithACRConditions {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter csvWriter = new FileWriter("resultsDependingOnCollisionRatio.csv")) {
            ...
            for (String testCase : testCases) {
                ...
                double acr = (( numElements / (double)maxElement) - 1) * maxElement / numElements;
