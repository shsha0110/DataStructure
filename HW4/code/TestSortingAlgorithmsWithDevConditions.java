...
public class TestSortingAlgorithmsWithDevConditions {
    private static int dataSize = 1000000;
    private static final String[] algorithms = {"H", "M", "Q", "R"};
    public static void main(String[] args) {

        try (FileWriter csvWriter = new FileWriter("resultsDependingOnStandardDeviation.csv")) {
            csvWriter.append("Test Case,Algorithm,Execution Time, std\n");

            for (double i = 0.10; i <= 10.00; i += 0.01) {
                String testCase = String.format("r %d %.2f", dataSize, i);
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", testCase, algorithm, String.valueOf(executionTime), String.format("%.2f", i)));
                    csvWriter.append("\n");
                }
