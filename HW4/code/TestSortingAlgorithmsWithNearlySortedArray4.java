...
public class TestSortingAlgorithmsWithNearlySortedArray4 {
    private static final String[] algorithms = {"I", "H", "M", "Q", "R"};
//    private static final String[] algorithms = {"R"};
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("resultsDependingOnSortedRatio_size1e5_earlyStop.csv")) {
            csvWriter.append("Algorithm,swapRate,SortedRatio,ExecutionTime\n");

            int cnt = 0;
            for (double swapRate = 0; swapRate <= 1; swapRate += INCREMENT) {
                System.out.println(String.format("started : %.5f", swapRate));

                int[] originalValues = generateNearlySortedArray(swapRate, ARRAY_SIZE);
                double sortedRatio = calculateSortedRatio(originalValues);
                ...
                for (String algorithm : algorithms) {
                    ...
                    if (executionTime > 100) { cnt++; }

                    csvWriter.append(String.join(",", algorithm, String.format("%.5f",swapRate), String.format("%.5f", sortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
    ...
    public static int[] generateNearlySortedArray(double swapRate, int size) {
    ...
    public static double calculateSortedRatio(int[] array) {
        int sortedPairCount = 0;
        ...
        return (double) sortedPairCount / totalPairs;
    }
