...
public class TestSortingAlgorithmsWithDevConditionsForDoSearch {
    private static int dataSize = 50000;
    private static final String[] algorithms = {"B","I","H", "M", "Q", "R"};
    public static void main(String[] args) {

        try (FileWriter csvWriter = new FileWriter("resultsDependingOnStandardDeviation_size50000.csv")) {
            csvWriter.append("Test Case,Algorithm,Execution Time,std\n");

            for (double i = 0.10; i <= 1; i += 0.001) {
                String testCase = String.format("r %d %.4f", dataSize, i);
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", testCase, algorithm, String.valueOf(executionTime), String.format("%.4f", i)));
                    csvWriter.append("\n");
                }
                System.out.println(String.format("Dev : %.4f", i));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
