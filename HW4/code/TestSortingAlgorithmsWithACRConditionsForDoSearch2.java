...
public class TestSortingAlgorithmsWithACRConditionsForDoSearch2 {
    private static final String[] algorithms = {"B","I","H", "M", "Q", "R"};
    public static void main(String[] args) {


        try (FileWriter csvWriter = new FileWriter("resultsDependingOnCollisionRatio_size50000_different.csv")) {
            csvWriter.append("Test Case,Algorithm,Execution Time,ACR\n");

            for (int i = 0; i < 1000; i++) {
                String testCase = String.format("r 50000 0 %d", i);
                System.out.println(String.format("started : %s", testCase));
                for (int trial = 0; trial < 1; trial++) {
                    System.out.println(String.format("\tstarted : #%d trial", trial+1));
                    ...
                    double acr = calculateAverageCollisionRate(originalValues);
    ...
    public static double calculateAverageCollisionRate(int[] array) {
        ...
        return (double) collisionCount / (array.length - 1);
    }
