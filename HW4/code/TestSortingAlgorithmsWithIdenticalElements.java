...
public class TestSortingAlgorithmsWithIdenticalElements {
    private static final String[] algorithms = {"B", "I", "H", "M", "Q", "R"};
    private static final int TEST_COUNT = 1000;

    public static void main(String[] args) {
        String[] testCases = {"r 10000 0 0", "r 100000 0 0", "r 1000000 0 0"};

        try (FileWriter csvWriter = new FileWriter("results_identical_elements.csv")) {
            csvWriter.append("Test Size,Algorithm,Run,Average Time,Std Dev,Min Time,Max Time\n");
            ...
            for (String testCase : testCases) {
                ...
                for (String algorithm : algorithms) {
                    ...
                    double averageTime = (double) totalTime / TEST_COUNT;
                    double variance = 0.0;
                    for (long time : times) {
                    ...
                    csvWriter.append(String.format("%s,%s,%d,%.4f,%.2f,%d,%d\n", testCase, algorithm, TEST_COUNT, averageTime, stdDev, minTime, maxTime));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
