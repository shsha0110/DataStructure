...
public class TestSortingAlgorithmsWithNearlyReverseSortedArrayForDoSearch {
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("232_resultsDependingOnReverseSortedRatio_size50000.csv")) {
            csvWriter.append("Algorithm,swapRate,ReverseSortedRatio,ExecutionTime\n");

            for (double swapRate = 0; swapRate <= 0.1; swapRate += INCREMENT) {
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", algorithm, String.format("%.4f",swapRate), String.format("%.5f", reverseSortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
                }
            }
        } catch (IOException e) {
