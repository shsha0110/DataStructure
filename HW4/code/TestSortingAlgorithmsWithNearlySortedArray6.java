...
public class TestSortingAlgorithmsWithNearlySortedArray6 {
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("resultsDependingOnSortedRatio_size1e6_without_InsertionSort_earlyStop.csv")) {
            ...
            for (double swapRate = 0; swapRate <= 1; swapRate += INCREMENT) {
                ...
                for (String algorithm : algorithms) {
                    ...
                    if (executionTime > 100) {break;}


                    csvWriter.append(String.join(",", algorithm, String.format("%.5f",swapRate), String.format("%.6f", sortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
