...
public class TestSortingAlgorithmsWithNearlySortedArray3 {
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("resultsDependingOnSortedRatio_size1e6_without_InsertionSort.csv")) {
