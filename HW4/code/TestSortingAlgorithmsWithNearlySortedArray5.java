...
public class TestSortingAlgorithmsWithNearlySortedArray5 {
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("222_resultsDependingOnSortedRatio_size1e6_term1e-4.csv")) {
            csvWriter.append("Algorithm,swapRate,SortedRatio,ExecutionTime\n");

            for (double swapRate = 0; swapRate <= 1; swapRate += INCREMENT) {
                System.out.println(String.format("started : %.4f", swapRate));
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", algorithm, String.format("%.4f",swapRate), String.format("%.6f", sortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
