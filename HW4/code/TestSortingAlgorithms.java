...
public class TestSortingAlgorithms {
    public static void main(String[] args) {
        String[] testCases = {
                ...
                "rs 1000 -1000 1000",
                "rs 10000 -10000 10000",
                "rs 100000 -100000 100000",
                "rs 1000000 -1000000 1000000",
                "rr 1000 -1000 1000",
                "rr 10000 -10000 10000",
                "rr 100000 -100000 100000",
                "rr 1000000 -1000000 1000000"
        };

//        String[] algorithms = {"B", "I", "H", "M", "Q", "R"};
//        String[] algorithmNames = {"Bubble Sort", "Insertion Sort", "Heap Sort", "Merge Sort", "Quick Sort", "Radix Sort"};
        String[] algorithms = {"B"};
        String[] algorithmNames = {"Bubble Sort"};

        int testRuns = 30;

        try (FileWriter writer = new FileWriter("resultsB.csv")) {
            writer.write("Test Case,Algorithm,Avg Time,Std Dev,Min Time,Max Time\n");
            ...
            for (String testCase : testCases) {
                ...
                for (int algoIndex = 0; algoIndex < algorithms.length; algoIndex++) {
                    ...
                    double stdDev = calculateStdDev(runTimes, avgTime);

                    writer.write(String.format("%s,%s,%.2f,%.2f,%d,%d%n", testCase, algoName, avgTime, stdDev, minTime, maxTime));
                }
