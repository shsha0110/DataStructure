...
public class TestSortingAlgorithmsWithDevConditions2 {
     private static int dataSize = 1000000;
    private static final String[] algorithms = {"H", "Q", "R"};
    public static void main(String[] args) {

        try (FileWriter csvWriter = new FileWriter("resultsDependingOnStandardDeviation_under1_term1e-4.csv")) {
            csvWriter.append("Test Case,Algorithm,Execution Time,std\n");

            for (double i = 0.10; i <= 1; i += 0.0001) {
