...
public class TestSortingAlgorithmsWithNearlyReverseSortedArray {
    ...
    public static void main(String[] args) {
        try (FileWriter csvWriter = new FileWriter("232_resultsDependingOnReverseSortedRatio_size1e6_term1e-4.csv")) {
            ...
            for (double swapRate = 0; swapRate <= 1; swapRate += INCREMENT) {
                ...
                for (String algorithm : algorithms) {
                    ...
                    csvWriter.append(String.join(",", algorithm, String.format("%.4f",swapRate), String.format("%.6f", reverseSortedRatio), String.valueOf(executionTime)));
                    csvWriter.append("\n");
                }
            }
        } catch (IOException e) {
